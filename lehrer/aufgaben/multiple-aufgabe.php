    ...
    <div class="content">
        ...
        <div class="erstellen">
            <?php
                ...
                // $korrekte_Antwort = 
                mysqli_query($con, "INSERT INTO `Aufgaben_MC` (`ID_Aufgaben_MC`, `ID_Aufgaben_MC_Lehrer`, `Korrekte_MC_Antworten`, `Schulfach`, `Klasse`, `Frage_MC`, `Antwort-A`, `Antwort-B`, `Antwort-C`, `Antwort-D`, `Bild_Link`) VALUES (NULL, '$ID_Nutzer', '$korrekte_Antwort', '$Fächer', '$Klassen', '$Frage', '$Antwort_A', '$Antwort_B', '$Antwort_C', '$Antwort_D', '$Bild_link');");
