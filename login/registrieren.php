      ...
      <div class="container">
        ...
        <?php 
         ...
         if(isset($_POST['submit'])){
            ...
            if(mysqli_num_rows($verify_query) != 0){
                ...
                mysqli_query($con, "INSERT INTO Benutzer(`Name`, `EMail`, `Passwort`, `Rolle_int`) VALUES('$name', '$email', '$hashed_password', $Rolle_int)") or die("Fehler aufgetreten - Datenbank Benutzer");
        ...
        ?>
            ...
            <form action="" method="post">
                ...
                <div class="links">
                    Schon einen Account? <a href="../login/index.php">Anmelden</a><br>
                    <p>Die mit * Gekenzeichnete sind pflicht!</p>
                </div>
            </form>
        </div>
        <?php } ?>
